...
import { existsSync, readFileStrSync,
  writeFileStrSync } from "https://deno.land/std@v0.34.0/fs/mod.ts";
import { resolve } from "https://deno.land/std@v0.34.0/path/mod.ts";
